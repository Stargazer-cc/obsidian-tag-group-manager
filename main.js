...
class TagGroupManagerSettingTab extends obsidian.PluginSettingTab {
    ...
    display() {
        ...
        this.plugin.settings.tagGroups.forEach((group, index) => {
            ...
            // 批量筛选添加按钮点击事件
            batchFilterBtn.addEventListener('click', () => __awaiter(this, void 0, void 0, function* () {
                ...
                if (isVisible) {
                    ...
                    batchFilterBtn.onclick;
                    batchFilterBtn.onclick = (e) => __awaiter(this, void 0, void 0, function* () {
                        // 阻止事件冒泡，避免触发外层的点击事件
                        e.stopPropagation();
                        e.preventDefault();
                        const selectedTagEls = filteredTagsContainer.querySelectorAll('.library-tag-item.selected');
